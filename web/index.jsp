...
<head>
    ...
    <link rel="stylesheet" href="Recursos/slide/css/style.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="Recursos/slide/css/slide.css" type="text/css" media="screen" />



    <script src="Recursos/jquery/jquery.min.js" type="text/javascript"></script>
    <script src="Recursos/slide/js/slide.js" type="text/javascript"></script>
...
<div id="toppanel">
	<div id="panel">
		<div class="content">
			...
			<div class="left">
				<!-- Login Form -->
                                <form class="clearfix" action="Admin/IndexFrame.jsp" method="post">
